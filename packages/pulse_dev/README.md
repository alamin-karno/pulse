...
[![pub.dev](https://img.shields.io/pub/v/pulse_dev.svg)](https://pub.dev/packages/pulse_dev)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

Pure Dart core for the [Pulse](https://github.com/pulse-dart/pulse) Developer
Intelligence SDK.

`pulse_dev` is Flutter-free and can be used in any Dart project — Flutter apps,
...
For Flutter applications, use [`pulse_dev_flutter`](../pulse_dev_flutter) which provides
